    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} VY Installatie. Alle rechten voorbehouden.</p> <a href="https://upseo.nl/website-laten-maken" target="_blank" rel="noopener noreferrer">website laten maken </a>
        </div>
      </div>
    </footer>
  );
